...
from helper_lib import get_model, train_diffusion
...
def main():
    ...
    model = train_diffusion(model, dl, device=device, epochs=1, max_batches_per_epoch=100)
    torch.save(model.state_dict(), "diffusion_cifar10.pt")
    print("Saved diffusion_cifar10.pt")
